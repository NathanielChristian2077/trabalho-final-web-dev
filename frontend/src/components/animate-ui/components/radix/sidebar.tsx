...
const sidebarMenuButtonVariants = cva(
  [
    ...
    "[&:not([data-highlight])]:hover:bg-zinc-300",
    "dark:[&:not([data-highlight])]:hover:bg-zinc-800",
    "[&:not([data-highlight])]:hover:text-zinc-900",
    "dark:[&:not([data-highlight])]:hover:text-zinc-50",

    "data-[active=true]:bg-sidebar-accent",
    "data-[active=true]:font-medium",
    "data-[active=true]:text-sidebar-accent-foreground",

    "[&:not([data-highlight])]:data-[state=open]:hover:bg-zinc-300",
    "dark:[&:not([data-highlight])]:data-[state=open]:hover:bg-zinc-800",
    "[&:not([data-highlight])]:data-[state=open]:hover:text-zinc-900",
    "dark:[&:not([data-highlight])]:data-[state=open]:hover:text-zinc-50",
  ].join(" "),
  {
    variants: {
      variant: {
        default: "",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] [&:not([data-highlight])]:hover:shadow-[0_0_0_1px_hsl(var(--sidebar-border))]",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
