              ...
              >
                ...
                >
                  ...
                  <circle
                    ...
                    cy={0}
                    r={centerRadius}
                    className="stroke-1 fill-neutral-100 opacity-50 stroke-neutral-400 dark:fill-neutral-950 dark:stroke-neutral-600"
                  />
                  <circle
                    cx={0}
                    cy={0}
...
/* ---------------------------------------------------------------------- */
/* CONTROLLED VERSION FOR GRAPH OVERLAY (NO CONTEXT MENU)                 */
/* ---------------------------------------------------------------------- */
...
export function RadialMenuOverlay({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={() => onSelect?.({ id: -1, label: "close", icon: X })}
        className="absolute left-1/2 top-1/2 z-20 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-neutral-900/80 text-neutral-300 shadow-md transition-colors hover:bg-red-600 hover:text-white"
      >
        <X className="h-5 w-5" />
      </button>
